...
可能细心的同学已经发现了，在`AutoService`的标签中我们新增了一个属性`autowire="byType"`,那么这个属性是什么意思呢？为什么加这个属性就能帮我们完成注入呢？不要急，我们带着问题继续往下看。![6](image/2019120202.png)
...
![2019120201](image/2019120201.jpg)
...
![2019120201](image/2019120203.jpg)
...
给自己加油，也给所有看到这篇文章的同学加油~！！![21](image/2019120502.png)
